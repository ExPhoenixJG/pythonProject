...
api_key = '0b5bc90d7c62b6d7e10c3ac187d90cc3'
...
app.title('Hava Durumu by ExPhoénix')

cityEntry = Entry(app, justify='center')
cityEntry.pack(fill=BOTH, ipady=10, padx=18, pady=5)
cityEntry.focus()

searchButton = Button(app, text='Ara', font=('Arial', 20), command=main)
searchButton.pack(fill=BOTH, ipady=3, padx=20)
